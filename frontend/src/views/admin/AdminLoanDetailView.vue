...
<template>
  <div class="admin-loan-detail-view">
    ...
    <p v-else-if="errorMessage && !loan" class="mt-6 font-body text-red-600">
      {{ errorMessage }}
    </p>
    <template v-else-if="loan">
      <div class="mt-6 space-y-4">
        <div class="clay-card p-4">
          ...
          <p class="font-body font-semibold text-slate-900">{{ loan.user?.fullName ?? loan.userFullName }}</p>
        </div>
        <div class="clay-card p-4">
      ...
      <div class="mt-6 flex flex-wrap gap-3">
        ...
        <template v-if="canRenew">
          ...
          <div v-else class="flex flex-wrap items-end gap-2">
            <div>
              <label for="admin-loan-newDueDate" class="sr-only">New due date</label>
              <input
                id="admin-loan-newDueDate"
                v-model="newDueDate"
                type="datetime-local"
